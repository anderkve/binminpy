...
if __name__ == "__main__":
    ...
    binning_tuples = [(-6, 6, 150), (-6, 6, 150), (-6, 6, 1), (-6, 6, 1)]
    ...
    #     },
    #     max_tasks_per_worker=125, # int(1000. / len(binning_tuples)) ,
    #     n_tasks_per_batch=1, # len(binning_tuples),
    #     n_restarts_per_bin=5,
    ...
    result = binminpy.diver(
        ...
        mcmc_options={
          ...
          "always_accept_target_below": -np.inf,  # -np.inf,  
          "always_accept_delta_target_below": 40., #80.,  # 0.
          "inherit_min_coords": False,
          "suggestion_cache_size": 10000,
        },
    ...
    if rank == 0:
        ...
        for target_dims in plot_combinations:
            ...
            ax.contour(grid_x0, grid_x1, grid_y, levels=[40], linewidths=1.5, colors='red')
