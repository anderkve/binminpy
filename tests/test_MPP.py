...
if __name__ == "__main__":
    ...
    # Test "minimize" function with MPP parallelization
    print()
    print("# Testing binned 'minimize' with MPP parallelization")
    print("----------------------------------------------------")
    ...
    # Test "differential_evolution" function with MPP parallelization
    print()
    print("# Testing binned 'differential_evolution' with MPP parallelization")
    print("------------------------------------------------------------------")
    ...
    # Test "basinhopping" function with MPP parallelization
    print()
    print("# Testing binned 'basinhopping' with MPP parallelization")
    print("--------------------------------------------------------")
    ...
    # Test "dual_annealing" function with MPP parallelization
    print()
    print("# Testing binned 'dual_annealing' with MPP parallelization")
    print("----------------------------------------------------------")
    ...
    # Test "direct" function with MPP parallelization
    print()
    print("# Testing binned 'direct' with MPP parallelization")
    print("--------------------------------------------------")
    ...
    # Test "iminuit" function with MPP parallelization
    print()
    print("# Testing binned 'iminuit' with MPP parallelization")
    print("---------------------------------------------------")
    ...
    # Test "diver" function with MPP parallelization
    print()
    print("# Testing binned 'diver' with MPP parallelization")
    print("-------------------------------------------------")
